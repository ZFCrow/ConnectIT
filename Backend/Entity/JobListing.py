...
class JobListing:
    ...
    def from_dict( cls, data: dict):
        """
        Create a JobListing instance from a dictionary, handling Enums and Optionals.
        """
        ...
        application_deadline = datetime.fromisoformat(deadline) if isinstance(deadline, str) else deadline

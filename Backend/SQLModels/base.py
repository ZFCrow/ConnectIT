...
class DatabaseContext:
    """
    Database context manager with SSH tunnel support -
     similar to Entity Framework DbContext
    """
    ...
    def _create_engine(self):
        ...
        connection_string = (
            f"mysql+pymysql://{db_credentials['user']}:{db_credentials['password']}"  # noqa: E501
